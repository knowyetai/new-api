...
type Midjourney struct {
	BillingUserId int    `json:"-" gorm:"default:0"`
	BillingUnitId int    `json:"-" gorm:"default:0"`
	Id            int    `json:"id"`
	Code          int    `json:"code"`
...
// BillingPayerID preserves the original payer for delayed refunds.
func (t *Midjourney) BillingPayerID() int {
	if t.BillingUserId > 0 {
		return t.BillingUserId
	}
	return t.UserId
}
